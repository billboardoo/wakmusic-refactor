        ...
        newsList.forEach((item, i) => {
            ...
            news.push(
                <div className="news-area" key={i}>
                    <a href={`https://cafe.naver.com/steamindiegame/${item.id}`} target="_blank" rel="noreferrer">
                        <img src={`/static/news/${item.time}.png`} alt="" className="news-image"/>
